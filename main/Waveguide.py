...
def StarLevel():
    ...
    time.sleep(2)
    #====================================================================
    # Mover al Primer heliport-------------------------
    Select = pyautogui.locateOnScreen('assets\Mision\campaign\WaveGuide\Heliport_1.png', confidence = 0.8)
    pyautogui.moveTo(Select)
    CoorHeliport_1 = Select
    pyautogui.click(clicks=1)
    ...
    pyautogui.moveTo(CoorHeliport_1)
    time.sleep(2)
    #====================================================================
    # Mover al Segundo heliport-------------------------
    Select = pyautogui.locateOnScreen('assets\Mision\campaign\WaveGuide\Heliport_2.png', confidence = 0.7)
    pyautogui.moveTo(Select)
    CoorHeliport_2 = Select
    pyautogui.click(clicks=1)
    # Elejir primer echelon por defecto
    r = None
    while r is None:
    ...
    # select plan path
    # 1 node
    pyautogui.move(622, -200)
    pyautogui.click(clicks=1)
    # 2 node
    pyautogui.moveTo(CoorHeliport_2)
    pyautogui.click(clicks=1)
    ...
    r = None
    while r is None:
        r = pyautogui.locateOnScreen('assets\Mision\campaign\WaveGuide\FinishAttemp.png', confidence = 0.8)
...
def RetireTDoll():
    ...
    if (pyautogui.locateOnScreen('assets\RetirarTDoll\RetiriOpcionBoton.png', confidence = 0.8) is not None):
        ...
        r = None
        while r is None:
            r = pyautogui.locateOnScreen('assets\Mision\campaign\WaveGuide\LevelMap.png', confidence = 0.8)
        SelecMap = pyautogui.locateOnScreen('assets\Mision\campaign\WaveGuide\LevelMap.png', confidence = 0.8)
        ...
        pyautogui.click(clicks=1)
        #=======================================================================
        # COPY FISRT CODE UNU ME SLAIO MAL ASI Q TOCA COPIARLO DE NUEVO XD
        #=======================================================================
        # Ajelar la pantalla de un nivel
        r = None
        while r is None:
        ...
        #====================================================================
        # Mover al Segundo heliport-------------------------
        Select = pyautogui.locateOnScreen('assets\Mision\campaign\WaveGuide\Heliport_2.png', confidence = 0.8)
        pyautogui.moveTo(Select)
        CoorHeliport_2 = Select
        pyautogui.click(clicks=1)
        # Elejir primer echelon por defecto
