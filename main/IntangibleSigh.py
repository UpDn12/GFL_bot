...
def StarLevel():
    ...
    r = None
    while r is None:
        r = pyautogui.locateOnScreen('assets\Mision\campaign\InSigh\FinishAttemp.png', confidence = 0.8)
...
#esta funcion se la mensiona en la funcion de arriba xd
def RetireTDoll():
    time.sleep(2)
